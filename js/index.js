...
$(function () {
    ...
    function leap_action(contaminated, too_low, hand_detected, height, selected, selected_final, palmposition) {
        ...
        if (hand_detected) {
            ...
            $("#button" + selected_button).removeClass('btn-secondary').addClass('btn-primary');
            if(selected) {
                $(".btn").removeClass("font-weight-bold").addClass("font-weight-normal");
                $("#button" + selected_button).removeClass("font-weight-normal").addClass("font-weight-bold");
                if(selected_final) {
